 ...
 */
class Commentaire extends \gueye\blogBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'gueye\\blogBundle\\Entity\\Commentaire' . "\0" . 'article', '' . "\0" . 'gueye\\blogBundle\\Entity\\Commentaire' . "\0" . 'id', '' . "\0" . 'gueye\\blogBundle\\Entity\\Commentaire' . "\0" . 'auteur', '' . "\0" . 'gueye\\blogBundle\\Entity\\Commentaire' . "\0" . 'contenu', '' . "\0" . 'gueye\\blogBundle\\Entity\\Commentaire' . "\0" . 'date');
        }
